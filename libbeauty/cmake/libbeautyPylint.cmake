if(COMMAND libbeauty_pylint_add_target)
  return()
endif()
...
if(NOT PYLINT_FOUND)
  macro(libbeauty_pylint_add_target) # dummy
  endmacro()
  return()
endif()

macro(libbeauty_pylint_cleanup)
  foreach(__id ${PYLINT_TARGET_ID})
    libbeauty_clear_vars(
  ...
  endforeach()
  libbeauty_clear_vars(PYLINT_TARGET_ID)
endmacro()
libbeauty_pylint_cleanup()

macro(libbeauty_pylint_add_target)
...
(keep versions of libbeauty/libbeauty_contrib synchronized)
")
  endif()
  libbeauty_assert(__pylint_TARGET)
...
macro(libbeauty_pylint_add_directory_recurse __path)
  ...
  foreach(__script ${__python_scripts})
    libbeauty_pylint_add_target(TARGET ${__script} ${ARGN})
  endforeach()
endmacro()

macro(libbeauty_pylint_add_directory __path)
...
function(libbeauty_pylint_finalize)
  if(NOT PYLINT_FOUND)
    return()
  endif()
  ...
  libbeauty_cmake_script_append_var(PYLINT_CONFIG_SCRIPT
      PYLINT_EXECUTABLE
      PYLINT_TARGET_ID
  )
  set(__sources "")
  ...
  configure_file("${libbeauty_SOURCE_DIR}/cmake/templates/pylint.cmake.in" "${CMAKE_BINARY_DIR}/pylint.cmake" @ONLY)
