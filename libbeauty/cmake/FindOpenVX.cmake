libbeauty_clear_vars(HAVE_OPENVX)
...
if(OPENVX_INCLUDE_DIR AND OPENVX_LIBRARIES)
  ...
  try_compile(OPENVX_RENAMED_REF
      ...
      "${libbeauty_SOURCE_DIR}/cmake/checks/openvx_refenum_test.cpp"
...
if(NOT HAVE_OPENVX)
  libbeauty_clear_vars(HAVE_OPENVX OPENVX_LIBRARIES OPENVX_INCLUDE_DIR)
endif()
