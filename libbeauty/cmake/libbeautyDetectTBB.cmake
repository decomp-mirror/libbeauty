...
#   - "tbb" target exists and added to LIBBEAUTY_LINKER_LIBS

function(libbeauty_tbb_cmake_guess _found)
    ...
    if(TBB_FOUND)
      ...
      libbeauty_tbb_read_version("${_inc}")
...
function(libbeauty_tbb_env_verify)
...
function(libbeauty_tbb_env_guess _found)
  ...
  if (TBB_ENV_INCLUDE AND (TBB_ENV_LIB OR TBB_ENV_LIB_DEBUG))
    libbeauty_tbb_env_verify()
    libbeauty_tbb_read_version("${TBB_ENV_INCLUDE}")
...
function(libbeauty_tbb_read_version _path)
  find_file(TBB_VER_FILE tbb/tbb_stddef.h "${_path}" NO_DEFAULT_PATH CMAKE_FIND_ROOT_PATH_BOTH)
  libbeauty_parse_header("${TBB_VER_FILE}" TBB_VERSION_LINES TBB_VERSION_MAJOR TBB_VERSION_MINOR TBB_INTERFACE_VERSION CACHE)
endfunction()

#=====================================================================

if(BUILD_TBB)
  add_subdirectory("${libbeauty_SOURCE_DIR}/3rdparty/tbb")
  if(NOT TARGET tbb)
    return()
  endif()
  set(HAVE_TBB TRUE)
...
if(NOT HAVE_TBB)
  libbeauty_tbb_cmake_guess(HAVE_TBB)
endif()

if(NOT HAVE_TBB)
  libbeauty_tbb_env_guess(HAVE_TBB)
endif()
...
if(HAVE_TBB)
  list(APPEND LIBBEAUTY_LINKER_LIBS tbb)
endif()
