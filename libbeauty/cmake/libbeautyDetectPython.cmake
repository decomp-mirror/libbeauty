...
if(NOT ${found})
  libbeauty_check_environment_variables(${executable})
  if(${executable})
  ...
  if(_found)
    ...
    if(NOT ANDROID AND NOT APPLE_FRAMEWORK)
      libbeauty_check_environment_variables(${library_env} ${include_dir_env})
    ...
    if(NOT ANDROID AND NOT IOS)
      ...
      if(NOT _numpy_include_dirs)
        if(CMAKE_CROSSCOMPILING)
          message(STATUS "Cannot probe for Python/Numpy support (because we are cross-compiling libbeauty)")
