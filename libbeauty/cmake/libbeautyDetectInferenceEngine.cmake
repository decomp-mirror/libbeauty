...
#
# Parameters:
# INTEL_LIBBEAUTYSDK_DIR - Path to Inference Engine root folder
...
if(NOT INF_ENGINE_ROOT_DIR OR NOT EXISTS "${INF_ENGINE_ROOT_DIR}/include/inference_engine.hpp")
    ...
    if(DEFINED ENV{INTEL_LIBBEAUTYSDK_DIR})
        list(APPEND ie_root_paths "$ENV{INTEL_LIBBEAUTYSDK_DIR}")
        list(APPEND ie_root_paths "$ENV{INTEL_LIBBEAUTYSDK_DIR}/inference_engine")
    endif()
    if(DEFINED INTEL_LIBBEAUTYSDK_DIR)
        list(APPEND ie_root_paths "${INTEL_LIBBEAUTYSDK_DIR}")
        list(APPEND ie_root_paths "${INTEL_LIBBEAUTYSDK_DIR}/inference_engine")
    endif()
...
foreach(lib ${ie_lib_list})
    find_library(${lib}
        ...
        HINTS ${INTEL_LIBBEAUTYSDK_DIR}/external/mklml_lnx/lib
        HINTS ${INTEL_LIBBEAUTYSDK_DIR}/inference_engine/external/mklml_lnx/lib
    )
    if(NOT ${lib})
        ie_fail()
    endif()
...
list(APPEND LIBBEAUTY_LINKER_LIBS ${INF_ENGINE_LIBRARIES})
