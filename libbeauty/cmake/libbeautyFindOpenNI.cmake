# Main variables:
# OPENNI_LIBRARY and OPENNI_INCLUDES to link libbeauty modules with OpenNI
# HAVE_OPENNI for conditional compilation libbeauty with/without OpenNI
...
if(HAVE_OPENNI)
  libbeauty_parse_header("${OPENNI_INCLUDE_DIR}/XnVersion.h" OPENNI_VERSION_LINES XN_MAJOR_VERSION XN_MINOR_VERSION XN_MAINTENANCE_VERSION XN_BUILD_VERSION)
  if(XN_MAJOR_VERSION)
