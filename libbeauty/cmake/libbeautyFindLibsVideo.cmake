...
libbeauty_clear_vars(HAVE_VFW)
if(WITH_VFW)
  try_compile(HAVE_VFW
    "${libbeauty_BINARY_DIR}"
    "${libbeauty_SOURCE_DIR}/cmake/checks/vfwtest.cpp"
    CMAKE_FLAGS "-DLINK_LIBRARIES:STRING=vfw32")
endif(WITH_VFW)

# --- GStreamer ---
libbeauty_clear_vars(HAVE_GSTREAMER)
...
# --- unicap ---
libbeauty_clear_vars(HAVE_UNICAP)
if(WITH_UNICAP)
...
# --- PvApi ---
libbeauty_clear_vars(HAVE_PVAPI)
if(WITH_PVAPI)
...
# --- GigEVisionSDK ---
libbeauty_clear_vars(HAVE_GIGE_API)
if(WITH_GIGEAPI)
...
# --- Aravis SDK ---
libbeauty_clear_vars(HAVE_ARAVIS_API)
if(WITH_ARAVIS)
...
# --- Dc1394 ---
libbeauty_clear_vars(HAVE_DC1394 HAVE_DC1394_2)
if(WITH_1394)
  if(WIN32 AND MINGW)
      ...
      if(HAVE_DC1394_2)
        libbeauty_parse_pkg("libdc1394-2" "${DC1394_2_LIB_DIR}/pkgconfig" "")
        libbeauty_include_directories(${DC1394_2_INCLUDE_PATH})
...
# --- xine ---
libbeauty_clear_vars(HAVE_XINE)
if(WITH_XINE)
  CHECK_MODULE(libxine HAVE_XINE VIDEOIO)
endif(WITH_XINE)

# --- V4L ---
libbeauty_clear_vars(HAVE_LIBV4L HAVE_CAMV4L HAVE_CAMV4L2 HAVE_VIDEOIO)
if(WITH_V4L)
  if(WITH_LIBV4L)
...
# --- OpenNI ---
libbeauty_clear_vars(HAVE_OPENNI HAVE_OPENNI_PRIME_SENSOR_MODULE)
if(WITH_OPENNI)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyFindOpenNI.cmake")
endif(WITH_OPENNI)

libbeauty_clear_vars(HAVE_OPENNI2)
if(WITH_OPENNI2)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyFindOpenNI2.cmake")
endif(WITH_OPENNI2)

# --- XIMEA ---
libbeauty_clear_vars(HAVE_XIMEA)
if(WITH_XIMEA)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyFindXimea.cmake")
  if(XIMEA_FOUND)
    set(HAVE_XIMEA TRUE)
  endif()
endif(WITH_XIMEA)
...
# --- FFMPEG ---
libbeauty_clear_vars(HAVE_FFMPEG)
if(WITH_FFMPEG)
  if(WIN32 AND NOT ARM)
    include("${libbeauty_SOURCE_DIR}/3rdparty/ffmpeg/ffmpeg.cmake")
  ...
  elseif(PKG_CONFIG_FOUND)
    libbeauty_check_modules(FFMPEG libavcodec libavformat libavutil libswscale)
    libbeauty_check_modules(FFMPEG_libavresample libavresample)
    if(FFMPEG_libavresample_FOUND)
      libbeauty_append_build_options(FFMPEG FFMPEG_libavresample)
    endif()
    if(HAVE_FFMPEG)
      try_compile(__VALID_FFMPEG
          "${libbeauty_BINARY_DIR}"
          "${libbeauty_SOURCE_DIR}/cmake/checks/ffmpeg_test.cpp"
      ...
      if(NOT __VALID_FFMPEG)
        ...
        libbeauty_append_build_options(VIDEOIO FFMPEG)
      endif()
    endif()
  else()
...
libbeauty_clear_vars(HAVE_MSMF)
if(WITH_MSMF)
...
if(WITH_INTELPERC)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyFindIntelPerCSDK.cmake")
endif(WITH_INTELPERC)

if(WITH_MFX)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyDetectMediaSDK.cmake")
endif()

# --- gPhoto2 ---
libbeauty_clear_vars(HAVE_GPHOTO2)
if(WITH_GPHOTO2)
...
# --- VA & VA_INTEL ---
if(WITH_VA_INTEL)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyFindVA_INTEL.cmake")
  if(VA_INTEL_IOCL_INCLUDE_DIR)
    libbeauty_include_directories(${VA_INTEL_IOCL_INCLUDE_DIR})
  endif()
  set(WITH_VA YES)
endif(WITH_VA_INTEL)

if(WITH_VA)
  include("${libbeauty_SOURCE_DIR}/cmake/libbeautyFindVA.cmake")
  if(VA_INCLUDE_DIR)
    libbeauty_include_directories(${VA_INCLUDE_DIR})
  endif()
endif(WITH_VA)
