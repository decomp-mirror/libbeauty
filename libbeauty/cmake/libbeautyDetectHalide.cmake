...
libbeauty_check_environment_variables(HALIDE_ROOT_DIR)
...
if(NOT HAVE_HALIDE AND HALIDE_ROOT_DIR)
  ...
  if(NOT HAVE_HALIDE)
    libbeauty_clear_vars(HALIDE_LIBRARIES HALIDE_INCLUDE_DIRS CACHE)
  endif()
endif()

if(HAVE_HALIDE)
  include_directories(${HALIDE_INCLUDE_DIRS})
  list(APPEND LIBBEAUTY_LINKER_LIBS ${HALIDE_LIBRARIES})
else()
  libbeauty_clear_vars(HALIDE_INCLUDE_DIRS HALIDE_LIBRARIES)
endif()
