...
MACRO(_PCH_GET_COMPILE_FLAGS _out_compile_flags)
    ...
    FOREACH(item ${DIRINC})
        libbeauty_is_libbeauty_directory(__result ${item})
        if(__result)
    ...
    FOREACH(src ${_sources})
      if(NOT "${src}" MATCHES "\\.mm$" AND NOT "${src}" MATCHES "\\.rc$")
        ...
        if(NOT _flags AND NOT _flags2)
          ...
          #libbeauty_debug_message("Skip PCH, flags: ${oldProps} defines: ${oldProps2}, file: ${src}")
        endif()
      endif()
    ENDFOREACH()
...
MACRO(ADD_PRECOMPILED_HEADER _targetName _input)
    ...
    set_target_properties(${_targetName}_pch_dephelp PROPERTIES
      DEBUG_POSTFIX "${LIBBEAUTY_DEBUG_POSTFIX}"
    ...
    if(type STREQUAL "SHARED_LIBRARY" OR type STREQUAL "STATIC_LIBRARY")
      ...
      if(__pic AND CMAKE_CXX_COMPILE_OPTIONS_PIC
          AND NOT LIBBEAUTY_SKIP_PCH_PIC_HANDLING
          AND NOT LIBBEAUTY_SKIP_PCH_PIC_HANDLING_${_targetName}
      )
    ...
    elseif(type STREQUAL "EXECUTABLE")
      ...
      if(__pie AND CMAKE_CXX_COMPILE_OPTIONS_PIE
          AND NOT LIBBEAUTY_SKIP_PCH_PIE_HANDLING
          AND NOT LIBBEAUTY_SKIP_PCH_PIE_HANDLING_${_targetName}
      )
...
macro(libbeauty_add_precompiled_header_to_target the_target pch_header)
