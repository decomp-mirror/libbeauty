...
if(HAVE_QT5 AND ${VTK_VERSION} VERSION_LESS "6.0.0")
  if(VTK_USE_QT)
    message(STATUS "VTK support is disabled. Incompatible combination: libbeauty + Qt5 and VTK ver.${VTK_VERSION} + Qt4")
  endif()
endif()
...
if(HAVE_QT5 AND ${VTK_VERSION} VERSION_EQUAL "6.0.0" AND NOT DEFINED FORCE_VTK)
  message(STATUS "VTK support is disabled. Possible incompatible combination: libbeauty+Qt5, and VTK ver.${VTK_VERSION} with Qt4")
...
if(HAVE_QT AND ${VTK_VERSION} VERSION_GREATER "6.0.0" AND NOT ${VTK_QT_VERSION} STREQUAL "")
  ...
  if(NOT HAVE_QT5 AND ${VTK_QT_VERSION} EQUAL "5")
    message(STATUS "VTK support is disabled. Incompatible combination: libbeauty + Qt4 and VTK ver.${VTK_VERSION} + Qt5")
    return()
  endif()
endif()
